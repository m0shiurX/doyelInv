        ...
        <form method="POST" action="{{ route("admin.crm-customers.update", [$crmCustomer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-6">
                    ...
                    <input class="form-control {{ $errors->has('account_no') ? 'is-invalid' : '' }}" type="number" name="account_no" id="account_no" value="{{ old('account_no', $crmCustomer->account_no) }}" required>
