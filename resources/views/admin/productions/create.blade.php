    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.productions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('weight_produced') ? 'is-invalid' : '' }}" type="number" name="weight_produced" id="weight_produced" value="{{ old('weight_produced', '') }}" step="0.01" required>
